package com.example.privatenotes.auth;
...
import com.example.privatenotes.MainActivity;
import com.example.privatenotes.Splash;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Login to PrivateNotes");
    ...
    private void showWarning() {
        final AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setMessage("You are on Temporary Account page. Logging into to a registered user will take you away from the temp page and require signing out to get back to it do you want to continue?")
